...
static DefaultCompressionMethod internal_compression_methods[] = {
    ...
    {CompressionType::COMPRESSION_DELTA, DeltaEncodingCompressionFun::GetFunction, DeltaEncodingCompressionFun::TypeIsSupported},
...
vector<reference<CompressionFunction>> DBConfig::GetCompressionFunctions(PhysicalType data_type) {
	...
	TryLoadCompression(*this, result, CompressionType::COMPRESSION_DELTA, data_type);
